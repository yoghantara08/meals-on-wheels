  ...
  const donatedItem = [
    {
      ...
      amount: 200000,
      message:
        '"Together, we can create a brighter future for those in need. I hope my donation makes a difference and help you."',
    },
    {
      name: "Name Donated",
      amount: 200000,
  ...
  return (
    <MainLayout>
      <div className="top-donate-page">
          ...
          <div className="container">
            <Row className="d-flex justify-content-center align-items-center mb-4">
              ...
              <Col xs="12" lg="5" className="column-content-desc ps-lg-5">
                ...
                <p className="text-desc text-darken mb-3 fw-normal">
                ...
                <div className="d-flex justify-content-center align-items-center mb-2">
                  <Link
                    to="/donation/donate"
                    type="button"
                    className="btn btn-outline-shade-green fw-bold btn-donation text-shade-green"
                  >
                    Donate Now
                  </Link>
                </div>
        ...
        <section className="container-fluid py-4 my-5 bg-light-shade-green">
