...
export const getPendingUsers = async (token) => {
  return API.get(`${ADMIN_URL}/users/pending`, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const acceptUsers = async (token, userId) => {
  return API.put(`${ADMIN_URL}/accept-user/${userId}`, null, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const getPartners = async (token) => {
  return API.get(`${ADMIN_URL}/partners`, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const getPendingPartners = async (token) => {
  return API.get(`${ADMIN_URL}/partners/pending`, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const acceptPartners = async (token, partnerId) => {
  return API.put(`${ADMIN_URL}/accept-partner/${partnerId}`, null, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const getMeals = async (token) => {
  return API.get(`${ADMIN_URL}/meals`, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const addMeal = async (token, mealFormData) => {
  return API.post(`${ADMIN_URL}/meal/add`, mealFormData, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const editMeal = async (token, mealFormData, mealId) => {
  return API.put(`${ADMIN_URL}/meal/edit/${mealId}`, mealFormData, {
    headers: {
...
export const deleteMeal = async (token, mealId) => {
  return API.delete(`${ADMIN_URL}/meal/delete/${mealId}`, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const getOrderOnProgress = async (token) => {
  return API.get(`${ADMIN_URL}/order-on-progress`, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const getOrderComplete = async (token) => {
  return API.get(`${ADMIN_URL}/order-complete`, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const assignOrderToRider = async (token, orderId, riderId) => {
  return API.put(`${ADMIN_URL}/assign-to-rider/${orderId}/${riderId}`, null, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
